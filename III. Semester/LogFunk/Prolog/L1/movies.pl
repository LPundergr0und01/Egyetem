...
director(no_country_for_old_men,ethan_coen).
director(no_country_for_old_men,joel_coen).
actor(no_country_for_old_men,tommy_lee_jones,ed_tom_bell).
actor(no_country_for_old_men,javier_bardem,anton_chigurh).
actor(no_country_for_old_men,josh_brolin,llevelyin_moss).
actor(no_country_for_old_men,woody_harrelson,carson_wells).
actress(no_country_for_old_men,kelly_macdonald,carla_moss).
actor(no_country_for_old_men,garret_dillahunt,wendell).
actress(no_country_for_old_men,tess_harper,loretta_bell).
actor(no_country_for_old_men,barry_corbin,ellis).
actor(no_country_for_old_men,stephen_root,man_who_hires_wells).
actor(no_country_for_old_men,rodger_boyce,el_paso_sheriff).
actress(no_country_for_old_men,beth_grant,carla_jeans_mother).
actress(no_country_for_old_men,ana_reeder,poolside_woman).
actress(no_country_for_old_men,kit_gwin,sheriffs_secretary).
actor(no_country_for_old_men,zach_hopkins,stangled_deputy).
actor(no_country_for_old_men,chip_love,man_in_ford).
%
movie(true_grit,2007).
director(true_grit,ethan_coen).
director(true_grit,joel_coen).
actor(true_grit,jeff_bridges,rooster_cogburn).
actress(true_grit,hailee_steinfeld,mattie_ross).
actor(true_grit,matt_damon,la_boeuf).
actor(true_grit,josh_brolin,tom_chaney).
actor(true_grit,barry_pepper,lucky_ned_pepper).
actor(true_grit,dakin_matthews,col_stonehill).
actor(true_grit,jarlath_conroy,undertaker).
actor(true_grit,paul_rae,emmett_quincy).
actor(true_grit,domhnall_gleeson,moon_the_kid).
actress(true_grit,elizabeth_marvel,fortyyears_old_mattie).
actor(true_grit,roy_lee_jones,yarnell).
actor(true_grit,ed_corbin,bear_man).
actor(true_grit,leon_russom,sheriff).
actor(true_grit,bruce_green,harold_parmalee).
actress(true_grit,candyce_hinkle,boarding_house_landlady).
%
movie(a_serious_man,2009).
director(a_serious_man,ethan_coen).
director(a_serious_man,joel_coen).
actor(a_serious_man,michael_stuhlbarg,larry_gopnik).
actor(a_serious_man,richard_kind,uncle_arthur).
actor(a_serious_man,fred_melamed,sy_ableman).
actress(a_serious_man,sari_lennick,judith_gopnik).
actor(a_serious_man,aaron_wolff,danny_gopnik).
actress(a_serious_man,jessica_mcmanus,sarah_gopnik).
actor(a_serious_man,peter_breitmayer,mr_brandt).
actor(a_serious_man,brent_braunschweig,mitch_brandt).
actor(a_serious_man,david_kang,clive_park).
actor(a_serious_man,benjamin_portnoe,dannys_reefer_buddy).
actor(a_serious_man,jack_swiler,boy_on_bus).
actor(a_serious_man,andrew_s_lentz,cursing_boy_on_bus).
actor(a_serious_man,jon_kaminski_jr,mike_fagle).
actor(a_serious_man,ari_hoptman,arlen_finkle).
actor(a_serious_man,alan_mandell,rabbi_marshak).
%
movie(burn_after_reaading,2008).
director(burn_after_reading,ethan_coen).
director(burn_after_reading,joel_coen).
actor(burn_after_reading,george_clooney,harry_pfarrer).
actress(burn_after_reading,frances_mcdormand,linda_litzke).
actor(burn_after_reading,brad_pitt,chad_feldheimer).
actor(burn_after_reading,john_malkovich,osborne_cox).
actress(burn_after_reading,tilda_swinton,katie_cox).
actor(burn_after_reading,richard_jenkins,ted).
actress(burn_after_reading,elizabeth_marvel,sandy_pfarrer).
actor(burn_after_reading,david_rasche,cia_officer).
actor(burn_after_reading,jk_simmons,cia_superior).
actor(burn_after_reading,olek_krupa,krapotkin).
actor(burn_after_reading,michael_countryman,alan).
actor(burn_after_reading,kevin_sussman_tuchman,marsh_man).
actor(burn_after_reading,jr_horne,divorce_lawyer).
actor(burn_after_reading,hamilton_clancy,peck).
actor(burn_after_reading,armand_schultz,olson).
%
movie(the_rainmaker, 1997).
director(the_rainmaker,francis_ford_coppola).
actor(the_rainmaker,matt_damon,rudy_baylor).
actor(the_rainmaker,danny_devito,deck_shifflet).
actress(the_rainmaker,claire_danes,kelly_riker).
actor(the_rainmaker,jon_voight,leo_f_drummond).
actress(the_rainmaker,mary_kay,place_dot_black).
actor(the_rainmaker,dean_stockwell,judge_harvey_hale).
actress(the_rainmaker,teresa_wright,colleen_miss_birdie_birdsong).
actress(the_rainmaker,virginia_madsen,jackie_lemancyzk).
actor(the_rainmaker,mickey_rourke,bruiser_stone).
actor(the_rainmaker,andrew_shue,cliff_riker).
actor(the_rainmaker,red_west,buddy_black).
actor(the_rainmaker,johnny_whitworth,donny_ray_black).
actor(the_rainmaker,wayne_emmons,prince_thomas).
actor(the_rainmaker,adrian_roberts,butch).
actor(the_rainmaker,roy_scheider,wilfred_keeley).
%
movie(dracula, 1992).
director(dracula,francis_ford_coppola).
actor(dracula,gary_oldman,dracula).
actress(dracula,winona_ryder,mina_murray__elisabeta).
actor(dracula,anthony_hopkins,professor_abraham_van_helsing).
actor(dracula,keanu_reeves,jonathan_harker).
actor(dracula,richard_e_grant,dr_jack_seward).
actor(dracula,cary_elwes,lord_arthur_holmwood).
actor(dracula,billy_campbell,quincey_p_morris).
actress(dracula,sadie_frost,lucy_westenra).
actor(dracula,tom_waits,rm_renfield).
actress(dracula,monica_bellucci,draculas_bride).
actress(dracula,michaela_bercu,draculas_bride).
actress(dracula,florina_kendrick,draculas_bride).
actor(dracula,jay_robinson,mr_hawkins).
actor(dracula,im_hobson,hobbs).
actress(dracula,laurie_franks,lucys_maid).
%
movie(youth_without_youth, 1992).
director(youth_without_youth,francis_ford_coppola).
actor(youth_without_youth,tim_roth,dominic).
actor(youth_without_youth,alexandra_maria_lara,veronica_laura).
actor(youth_without_youth,bruno_ganz,professor_stanciulescu).
actor(youth_without_youth,andre_hennicke,josef_rudolf).
actor(youth_without_youth,marcel_iures,prof_giuseppe_tucci).
actor(youth_without_youth,adrian_pintea,pandit).
actor(youth_without_youth,alexandra_pirici,woman_in_room_6).
actor(youth_without_youth,florin_piersic,jr_dr_gavrila).
actor(youth_without_youth,zoltan_butuc,dr_chirila).
actor(youth_without_youth,adriana_titieni,anetta).
%
movie(eyes_wide_shut,1999).
director(eyes_wide_shut,stanley_kubrick).
actor(eyes_wide_shut,tom_cruise,dr_william_harford).
actress(eyes_wide_shut,nicole_kidman,alice_harford).
actress(eyes_wide_shut,madison_eginton,helena_harford).
actress(eyes_wide_shut,jackie_sawiris,roz).
actor(eyes_wide_shut,sydney_pollack,victor_ziegler).
actress(eyes_wide_shut,leslie_lowe,illona_ziegler).
actor(eyes_wide_shut,peter_benson,bandleader).
actor(eyes_wide_shut,todd_field,nick_nightingale).
actor(eyes_wide_shut,michael_doven,zieglers_secretary).
actor(eyes_wide_shut,sky_du_mont,sandor_szavost).
actress(eyes_wide_shut,louise_j_taylor,gayle).
actor(eyes_wide_shut,stewart_thorndike_nuala).
actor(eyes_wide_shut,randall_paul,harris).
actress(eyes_wide_shut,julienne_davis,mandy).
actress(eyes_wide_shut,lisa_leone,lisa).
%
movie(dogvile,2003).
director(dogvile,lars_von_trier).
actress(dogville,nicole_kidman,grace_margaret_mulligan).
actress(dogville,harriet_andersson,gloria).
actress(dogville,lauren_bacall,ma_ginger).
actor(dogville,jean-marc_barr,the_man_with_the_big_hat).
actor(dogville,paul_bettany,tom_edison).
actress(dogville,blair_brown,mrs_henson).
actor(dogville,james_caan,the_big_man).
actress(dogville,patricia_clarkson,vera).
actor(dogville,jeremy_davies,bill_henson).
actor(dogville,ben_gazzara,jack_mckay).
actor(dogville,philip_baker,hall_tom_edison_sr).
actor(dogville,thom_hoffman,gangster).
actress(dogville,siobhan_fallon,martha).
actor(dogville,john_hurt,narrator).
actor(dogville,zeljko_ivanek,ben).
%
movie(dancer_in_the_dark,2000).
director(dancer_in_the_dark,lars_von_trier).
actress(dancer_in_the_dark,bjork,selma_jezkova).
actress(dancer_in_the_dark,catherine_deneuve,kathy).
actor(dancer_in_the_dark,david_morse,bill_houston).
actor(dancer_in_the_dark,peter_stormare,jeff).
actor(dancer_in_the_dark,joel_grey,oldrich_novy).
actress(dancer_in_the_dark,cara_seymour,linda_houston).
actress(dancer_in_the_dark,vladica_kostic,gene_jezkova).
actor(dancer_in_the_dark,jean-marc_barr,norman).
actor(dancer_in_the_dark,vincent_paterson,samuel).
actress(dancer_in_the_dark,siobhan_fallon,brenda).
actor(dancer_in_the_dark,zeljko_ivanek,district_attorney).
actor(dancer_in_the_dark,udo_kier,dr_porkorny).
actor(dancer_in_the_dark,jens_albinus,morty).
actress(dancer_in_the_dark,reathel_bean,judge).
actress(dancer_in_the_dark,mette_berggreen,receptionist).
%
movie(manderlay,2005).
director(manderlay,lars_von_trier).
actress(manderlay,bryce_dallas_howard,grace_margaret_mulligan).
actor(manderlay,isaach_de_bankole,timothy).
actor(manderlay,danny_glover,wilhelm).
actor(manderlay,willem_dafoe,graces_father).
actor(manderlay,michael_abiteboul,thomas).
actress(manderlay,lauren_bacall,mam).
actor(manderlay,jean-marc_barr,mr_robinsson).
actor(manderlay,geoffrey_bateman,bertie).
actor(manderlay,virgile_bramly,edward).
actor(manderlay,ruben_brinkman,bingo).
actress(manderlay,dona_croll,venus).
actor(manderlay,jeremy_davies,niels).
actress(manderlay,llewella_gideon,victoria).
actress(manderlay,mona_hammond,old_wilma).
actress(manderlay,ginny_holder,elisabeth).
%
movie(antichrist,2009).
director(antichrist,lars_von_trier).
actor(antichrist,willem_dafoe,he).
actress(antichrist,charlotte_gainsbourg,she).
actor(antichrist,storm_acheche_sahlstrom,nic).
%
movie(nymphomaniac,2013).
director(nymphomaniac,lars_von_trier).
actress(nymphomaniac,charlotte_gainsbourg,joe).
actor(nymphomaniac,stellan_skarsgard,seligman).
actress(nymphomaniac,stacy_martin,young_joe).
actor(nymphomaniac,shia_labeouf,jerome).
actor(nymphomaniac,christian_slater,joes_father).
actress(nymphomaniac,jamie_bell,k).
actress(nymphomaniac,uma_thurman,mrs_h).
actor(nymphomaniac,willem_dafoe,l).
actress(nymphomaniac,mia_goth,p).
actress(nymphomaniac,sophie_kennedy_clark,b_girl).
actress(nymphomaniac,connie_nielsen,joes_mother).
actor(nymphomaniac,michael_pas,role_unnamed).
actor(nymphomaniac,jean-marc_barr,role_unnamed).
actor(nymphomaniac,udo_kier,the_waiter).
%
movie(full_metal_jacket,1987).
director(full_metal_jacket,stanley_kubrick).
actor(full_metal_jacket,matthew_modine,pvt_jt_joker_davis).
actor(full_metal_jacket,adam_baldwin,animal_mother).
actor(full_metal_jacket,vincent_donofrio,pvt_leonard_gomer_pyle_lawrence).
actor(full_metal_jacket,r_lee_ermey,gny_sgt_hartman).
actor(full_metal_jacket,dorian_harewood,eightball).
actor(full_metal_jacket,kevyn_major_howard,rafterman).
actor(full_metal_jacket,arliss_howard,pvt_cowboy).
actor(full_metal_jacket,ed_oross,lt_touchdown).
actor(full_metal_jacket,john_terry,lt_lockhart).
actor(full_metal_jacket,kieron_jecchinis,crazy_earl).
actor(full_metal_jacket,kirk_taylor,payback).
actor(full_metal_jacket,tim_colceri,doorgunner).
actor(full_metal_jacket,jon_stafford,doc_jay).
actor(full_metal_jacket,bruce_boa,poge_colonel).
actor(full_metal_jacket,ian_tyler,lt_cleves).
%
movie(apocalypse_now,1979).
director(apocalypse_now,francis_ford_coppola).
actor(apocalypse_now,marlon_brando,colonel_walter_e__kurtz).
actor(apocalypse_now,martin_sheen,captain_benjamin_l__willard).
actor(apocalypse_now,robert_duvall,lieutenant_colonel_bill_kilgore).
actor(apocalypse_now,frederic_forrest,jay_chef_hicks).
actor(apocalypse_now,sam_bottoms,lance_b__johnson).
actor(apocalypse_now,laurence_fishburne,tyrone_clean_miller).
actor(apocalypse_now,albert_hall,chief_phillips).
actor(apocalypse_now,harrison_ford,colonel_lucas).
actor(apocalypse_now,dennis_hopper,photojournalist).
actor(apocalypse_now,g_d__spradlin,general_corman).
actor(apocalypse_now,jerry_ziesmer,jerry,a_civilian).
actor(apocalypse_now,scott_glenn,lieutenant_richard_m__colby).
actor(apocalypse_now,bo_byers,mp_sergeant_no1).
actor(apocalypse_now,james_keane,kilgores_gunner).
actor(apocalypse_now,kerry_rossall,mike_from_san_diego).
%
movie(tigerland,2000).
director(tigerland,joel_schumacher).
actor(tigerland,colin_farrell,pvt__roland_bozz).
actor(tigerland,matthew_davis,pvt__jim_paxton).
actor(tigerland,clifton_collins_jr_,pvt__miter).
actor(tigerland,tom_guiry,pvt__cantwell).
actor(tigerland,shea_whigham,pvt__wilson).
actor(tigerland,russell_richardson,pvt__johnson).
actor(tigerland,nick_searcy,capt__saunders).
actor(tigerland,afemo_omilami,sfc_ezra_landers).
actor(tigerland,james_macdonald,staff_sgt__thomas).
actor(tigerland,keith_ewell,sgt__oakes).
actor(tigerland,matt_gerald,sgt__eveland).
actor(tigerland,stephen_fulton,sgt__drake).
actor(tigerland,tyler_cravens,m_p__sergeant).
actor(tigerland,michael_edmiston,hit_the_brakes_driver).
actor(tigerland,arian_waring_ash,sheri).
%
movie(rome_open_city,1945).
director(rome_open_city,roberto_rossellini).
actor(rome_open_city,aldo_fabrizi,don_pietro_pellegrini).
actress(rome_open_city,anna_magnani,pina).
actor(rome_open_city,marcello_pagliero,giorgio_manfredi_aka_luigi_ferraris).
actor(rome_open_city,vito_annichiarico,piccolo_marcello).
actor(rome_open_city,nando_bruno,agostino_the_sexton).
actor(rome_open_city,harry_feist,major_bergmann).
actress(rome_open_city,giovanna_galletti,ingrid).
actor(rome_open_city,francesco_grandjacquet,francesco).
actor(rome_open_city,eduardo_passarelli,neighborhood_police_sergeant).
actress(rome_open_city,maria_michi,marina_mari).
actress(rome_open_city,carla_rovere,lauretta).
actor(rome_open_city,carlo_sindici,police_commissioner).
actor(rome_open_city,joop_van_hulzen,captain_hartmann).
actor(rome_open_city,akos_tolnay,austrian_deserter).
%
movie(the_deer_hunter,1978).
director(the_deer_hunter,michael_cimino).
actor(the_deer_hunter,robert_de_niro,michael).
actor(the_deer_hunter,john_cazale,stan).
actor(the_deer_hunter,john_savage,steven).
actor(the_deer_hunter,christopher_walken,nick).
actress(the_deer_hunter,meryl_streep,linda).
actor(the_deer_hunter,george_dzundza,john).
actor(the_deer_hunter,chuck_aspegren,axel).
actress(the_deer_hunter,shirley_stoler,stevens_mother).
actress(the_deer_hunter,rutanya_alda,angela).
actor(the_deer_hunter,pierre_segui,julien).
actress(the_deer_hunter,mady_kaplan,axels_girl).
actress(the_deer_hunter,amy_wright,bridesmaid).
actress(the_deer_hunter,mary_ann_haenel,stans_girl).
actor(the_deer_hunter,richard_kuss,lindas_father).
actor(the_deer_hunter,joe_grifasi,bandleader).
%
movie(mulholland_drive,2001).
director(mulholland_drive,david_lynch).
actress(mulholland_drive,naomi_watts,betty_elms_diane_selwyn).
actress(mulholland_drive,laura_harring,rita).
actress(mulholland_drive,ann_miller,catherine_coco_lenoix).
actor(mulholland_drive,dan_hedaya,vincenzo_castigliane).
actor(mulholland_drive,justin_theroux,adam_kesher).
actor(mulholland_drive,brent_briscoe,detective_neal_domgaard).
actor(mulholland_drive,robert_forster,detective_harry_mcknight).
actress(mulholland_drive,katharine_towne,cynthia_jenzen).
actor(mulholland_drive,lee_grant,louise_bonner).
actor(mulholland_drive,scott_coffey,wilkins).
actor(mulholland_drive,billy_ray_cyrus,gene).
actor(mulholland_drive,chad_everett,jimmy_katz).
actress(mulholland_drive,rita_taggart,linney_james).
actor(mulholland_drive,james_karen,wally_brown).
actress(mulholland_drive,lori_heuring,lorraine_kesher).
%
movie(last_vegas,2013).
director(last_vegas,jon_turteltaub).
actor(last_vegas,michael_douglas,billy).
actor(last_vegas,robert_de_niro,paddy).
actor(last_vegas,morgan_freeman,archie).
actor(last_vegas,kevin_kline,sam).
actress(last_vegas,mary_steenburgen,diana).
actor(last_vegas,jerry_ferrara,dean).
actor(last_vegas,romany_malco,lonnie).
actor(last_vegas,roger_bart,maurice).
actress(last_vegas,joanna_gleason,miriam).
actor(last_vegas,michael_ealy,ezra).
actress(last_vegas,bre_blair,lisa).
actress(last_vegas,april_billingsley,maid_of_honor).
actor(last_vegas,stephen_scott_scarpulla,danny_the_greaser).
actress(last_vegas,andrea_moore,bachelorette).
actor(last_vegas,noah_harden,young_billy).
%
movie(being_flynn,2012).
director(being_flynn,paul_weitz).
actor(being_flynn,robert_de_niro,jonathan_flynn).
actor(being_flynn,paul_dano,nick_flynn).
actress(being_flynn,julianne_moore,jody_flynn).
actress(being_flynn,olivia_thirlby,denise).
actor(being_flynn,eddie_rouse,carlos).
actor(being_flynn,steve_cirbus,jeff).
actress(being_flynn,lili_taylor,joy).
actor(being_flynn,victor_rasuk,gabriel).
actor(being_flynn,liam_broggy,young_nick).
actor(being_flynn,chris_chalk,ivan).
actor(being_flynn,wes_studi,captain).
actor(being_flynn,thomas_middleditch,richard).
actress(being_flynn,sarah_quinn,religious_girl).
actor(being_flynn,ben_foronda,punky_guy).
actress(being_flynn,dale_dickey,marie).
%
movie(fifty_fifty,2011).
director(fifty_fifty,jonathan_levine).
actor(fifty_fifty,joseph_gordon-levitt,adam).
actor(fifty_fifty,seth_rogen,kyle).
actress(fifty_fifty,anna_kendrick,katherine).
actress(fifty_fifty,bryce_dallas_howard,rachael).
actress(fifty_fifty,anjelica_huston,diane).
actor(fifty_fifty,serge_houde,richard).
actor(fifty_fifty,andrew_airlie,dr__ross).
actor(fifty_fifty,matt_frewer,mitch).
actor(fifty_fifty,philip_baker_hall,alan).
actress(fifty_fifty,donna_yamamoto,dr__walderson).
actor(fifty_fifty,sugar_lyn_beard,susan).
actor(fifty_fifty,yee_jee_tso,dr__lee).
actress(fifty_fifty,sarah_smyth,jenny).
actor(fifty_fifty,peter_kelamis,phil).
actress(fifty_fifty,jessica_parker_kennedy,jackie).
%
movie(silver_linings_playbook,2012).
director(silver_linings_playbook,david_russell).
actor(silver_linings_playbook,bradley_cooper,pat).
actress(silver_linings_playbook,jennifer_lawrence,tiffany).
actor(silver_linings_playbook,robert_de_niro,pat_sr_).
actress(silver_linings_playbook,jacki_weaver,dolores).
actor(silver_linings_playbook,chris_tucker,danny).
actor(silver_linings_playbook,anupam_kher,dr__cliff_patel).
actor(silver_linings_playbook,john_ortiz,ronnie).
actress(silver_linings_playbook,shea_whigham,jake).
actress(silver_linings_playbook,julia_stiles,veronica).
actor(silver_linings_playbook,paul_herman,randy).
actor(silver_linings_playbook,dash_mihok,officer_keogh).
actor(silver_linings_playbook,matthew_russell,ricky_dangelo).
actress(silver_linings_playbook,cheryl_williams,tiffanys_mother).
actor(silver_linings_playbook,patrick_mcdade,tiffanys_father).
actress(silver_linings_playbook,brea_bee,nikki).
%
movie(red_lights,2012).
director(red_lights,rodrigo_cortes).
actor(red_lights,cillian_murphy,tom_buckley).
actress(red_lights,sigourney_weaver,margaret_matheson).
actor(red_lights,robert_de_niro,simon_silver).
actor(red_lights,toby_jones,paul_shackleton).
actress(red_lights,joely_richardson,monica_hansen).
actress(red_lights,elizabeth_olsen,sally_owen).
actor(red_lights,craig_roberts,ben).
actor(red_lights,leonardo_sbaraglia,leonard_palladino).
actress(red_lights,adriane_lenox,rina).
actor(red_lights,garrick_hagon,howard_mccolm).
actor(red_lights,burn_gorman,benedict_cohen).
actor(red_lights,mitchell_mullen,jim_carroll).
actor(red_lights,nathan_osgood,michael_sidgwick).
actress(red_lights,madeleine_potter,sarah_sidgwick).
actress(red_lights,eloise_webb,susan_sidgwick).
%
movie(killing_season,2013).
director(killing_season,mark_steven_johnson).
actor(killing_season,robert_de_niro,benjamin_ford).
actor(killing_season,john_travolta,emil_kovac).
actor(killing_season,milo_ventimiglia,chris_ford).
actress(killing_season,elizabeth_olin,sarah_ford).
actress(killing_season,diana_lyubenova,elena).
actor(killing_season,kalin_sarmenov,serbian).
actor(killing_season,stefan_shterev,bar_customer).
%
movie(side_effects,2013).
director(side_effects,steven_soderbergh).
actress(side_effects,rooney_mara,emily_taylor).
actress(side_effects,carmen_pelaez,prison_desk_guard).
actor(side_effects,marin_ireland,upset_visitor).
actor(side_effects,channing_tatum,martin_taylor).
actress(side_effects,polly_draper,emilys_boss).
actress(side_effects,ann_dowd,martins_mother).
actor(side_effects,haraldo_alvarez,garage_attendant).
actor(side_effects,jude_law,dr_jonathan_banks).
actor(side_effects,james_martinez,police_officer_at_hospital).
actor(side_effects,vladimi_versailles,augustin).
actress(side_effects,jacqueline_antaramian,desk_nurse).
actress(side_effects,michelle_vergara_moore,joan).
actress(side_effects,catherine_zeta-jones,dr_victoria_siebert).
actress(side_effects,katie_lowes,conference_organizer).
actor(side_effects,david_costabile,carl).
%
movie(the_family,2013).
director(the_family,luc_besson).
actor(the_family,robert_de_niro,fred_blake___giovanni_manzoni).
actress(the_family,michelle_pfeiffer,maggie_blake).
actress(the_family,dianna_agron,belle_blake).
actor(the_family,john_d_leo,warren_blake).
actor(the_family,tommy_lee_jones,robert_stansfield).
actor(the_family,jimmy_palumbo,di_cicco).
actor(the_family,domenick_lombardozzi,caputo).
actor(the_family,stan_carp,don_luchese).
actor(the_family,vincent_pastore,fat_willy).
actor(the_family,jon_freda,rocco).
actor(the_family,michael_j_panichelli_jr,billy_the_bug).
actor(the_family,paul_borghese,albert).
actor(the_family,anthony_desio,bernie).
actor(the_family,ted_arcidi,tommy).
actor(the_family,david_belle,mezzo).
%
movie(the_big_blue,1988).
director(the_big_blue,luc_besson).
actress(the_big_blue,rosanna_arquette,johana_baker).
actor(the_big_blue,jean-marc_barr,jacques_mayol).
actor(the_big_blue,jean_reno,enzo_molinari).
actor(the_big_blue,paul_shenar,dr__laurence).
actor(the_big_blue,sergio_castellitto,novelli).
actor(the_big_blue,jean_bouise,uncle_louis).
actor(the_big_blue,marc_duret,roberto).
actor(the_big_blue,griffin_dunne,duffy).
actor(the_big_blue,andreas_voutsinas,priest).
actress(the_big_blue,valentina_vargas,bonita).
actress(the_big_blue,kimberly_beck,sally).
actor(the_big_blue,patrick_fontana,alfredo).
actress(the_big_blue,alessandra_vazzoler,la_mamma).
actor(the_big_blue,geoffrey_carey,supervisor).
actor(the_big_blue,bruce_guerre-berthelot,young_jacques).
%
movie(the_fifth_element,1997).
director(the_fifth_element,luc_besson).
actor(the_fifth_element,bruce_willis,korben_dallas).
actor(the_fifth_element,gary_oldman,jean-baptiste_emanuel_zorg).
actor(the_fifth_element,ian_holm,father_vito_cornelius).
actress(the_fifth_element,milla_jovovich,leeloo).
actor(the_fifth_element,chris_tucker,ruby_rhod).
actor(the_fifth_element,luke_perry,billy).
actor(the_fifth_element,brion_james,general_munro).
actor(the_fifth_element,tommy_lister,president_lindberg).
actor(the_fifth_element,lee_evans,fog).
actor(the_fifth_element,charlie_creed-miles,david).
actor(the_fifth_element,tricky,right_arm).
actor(the_fifth_element,john_neville,general_staedert).
actor(the_fifth_element,john_bluthal,professor_pacoli).
actor(the_fifth_element,mathieu_kassovitz,mugger).
actor(the_fifth_element,christopher_fairbank,mactilburgh).
%
movie(the_lady,2011).
director(the_lady,luc_besson).
actress(the_lady,michelle_yeoh,aung_san_suu_kyi).
actor(the_lady,david_thewlis,michael_aris).
actor(the_lady,jonathan_raggett,kim_aris).
actor(the_lady,jonathan_woodhouse,alexander_aris).
actress(the_lady,susan_wooldridge,lucinda_philips).
actress(the_lady,benedict_wong,karma).
actor(the_lady,agga_poechit,than_shwe).
actress(the_lady,donatienne_dupont,marie-laure_aris).
actor(the_lady,phoe_zaw,aung_san__the_father).
actress(the_lady,marian_yu,daw_khin_kyi__the_mother).
actress(the_lady,may,mon_mon).
actor(the_lady,ko_ko_win_aung,red_scarf_captain).
actor(the_lady,san_lwin,u_win_tin__writer).
actress(the_lady,nay_myo_thant,win_thein__student).
actress(the_lady,victoria_sanvalli,ma_thein__student).
%
movie(the_messenger_the_story_of_joan_of_arc,1999).
director(the_messenger_the_story_of_joan_of_arc,luc_besson).
actor(the_messenger_the_story_of_joan_of_arc,rab_affleck,comrade).
actor(the_messenger_the_story_of_joan_of_arc,stephane_algoud,look_out).
actor(the_messenger_the_story_of_joan_of_arc,edwin_apps,bishop).
actor(the_messenger_the_story_of_joan_of_arc,david_bailie,english_judge).
actor(the_messenger_the_story_of_joan_of_arc,david_barber,english_judge).
actor(the_messenger_the_story_of_joan_of_arc,christian_barbier,captain).
actor(the_messenger_the_story_of_joan_of_arc,timothy_bateson,english_judge).
actor(the_messenger_the_story_of_joan_of_arc,david_begg,nobleman_rouens_castle).
actor(the_messenger_the_story_of_joan_of_arc,christian_bergner,captain).
actor(the_messenger_the_story_of_joan_of_arc,andrew_birkin,talbot).
actor(the_messenger_the_story_of_joan_of_arc,dominic_borrelli,english_judge).
actor(the_messenger_the_story_of_joan_of_arc,john_boswall,old_priest).
actor(the_messenger_the_story_of_joan_of_arc,matthew_bowyer,the_bludgeoned_french_soldier).
actor(the_messenger_the_story_of_joan_of_arc,paul_brooke,domremys_priest).
actor(the_messenger_the_story_of_joan_of_arc,bruce_byron,joans_father).
%
movie(leon_the_professional,1994).
director(leon_the_professional,luc_besson).
actor(leon_the_professional,jean_reno,leon).
actor(leon_the_professional,gary_oldman,stansfield).
actress(leon_the_professional,natalie_portman,mathilda).
actor(leon_the_professional,danny_aiello,tony).
actor(leon_the_professional,peter_appel,malky).
actor(leon_the_professional,willi_one_blood,first_stansfield_man).
actor(leon_the_professional,don_creech,second_stansfield_man).
actor(leon_the_professional,keith_a_glascoe,thirrd_stansfield_man).
actor(leon_the_professional,randolph_scott,fourth_stansfield_man).
actor(leon_the_professional,michael_badalucco,mathildas_father).
actress(leon_the_professional,ellen_greene,mathildas_mother).
actress(leon_the_professional,elizabeth_regen,mathildas_sister).
actor(leon_the_professional,carl_j_matusovich,mathildas_brother).
actor(leon_the_professional,frank_senger,fatman).
actor(leon_the_professional,lucius_wyatt_cherokee,tonto).
%
movie(atlantis,1991).
director(atlantis,luc_besson).
%
movie(dr_strangelove_or_how_i_learned_to_stop_worrying_and_love_the_bomb,1964).
director(dr_strangelove_or_how_i_learned_to_stop_worrying_and_love_the_bomb,stanley_kubrick).
actor(dr_strangelove_or_how_i_learned_to_stop_worrying_and_love_the_bomb,peter_sellers,group_capt_lionel_mandrake_and_president_merkin_muffley_and_dr_strangelove).
actor(dr_strangelove_or_how_i_learned_to_stop_worrying_and_love_the_bomb,george_c_scott,gen_buck_turgidson).
actor(dr_strangelove_or_how_i_learned_to_stop_worrying_and_love_the_bomb,sterling_hayden,brig_gen_jack_ripper).
actor(dr_strangelove_or_how_i_learned_to_stop_worrying_and_love_the_bomb,keenan_wynn,col_bat_guano).
actor(dr_strangelove_or_how_i_learned_to_stop_worrying_and_love_the_bomb,slim_pickens,maj_king_kong).
actor(dr_strangelove_or_how_i_learned_to_stop_worrying_and_love_the_bomb,peter_bull,russian_ambassador_alexi_de_sadesky).
actor(dr_strangelove_or_how_i_learned_to_stop_worrying_and_love_the_bomb,james_earl_jones,lt_lothar_zogg).
actress(dr_strangelove_or_how_i_learned_to_stop_worrying_and_love_the_bomb,tracy_reed,miss_scott).
actor(dr_strangelove_or_how_i_learned_to_stop_worrying_and_love_the_bomb,jack_creley,mr_staines).
actor(dr_strangelove_or_how_i_learned_to_stop_worrying_and_love_the_bomb,frank_berry,lt_dietrich).
actor(dr_strangelove_or_how_i_learned_to_stop_worrying_and_love_the_bomb,robert_o_neil,adm_randolph).
actor(dr_strangelove_or_how_i_learned_to_stop_worrying_and_love_the_bomb,glenn_beck,lt_kivel).
actor(dr_strangelove_or_how_i_learned_to_stop_worrying_and_love_the_bomb,roy_stephens,frank).
actor(dr_strangelove_or_how_i_learned_to_stop_worrying_and_love_the_bomb,shane_rimmer,capt_owens).
actor(dr_strangelove_or_how_i_learned_to_stop_worrying_and_love_the_bomb,hal_galili,burpelson_afb_defense_team_member).
%
movie(the_shawshank_redemption,1994).
director(the_shawshank_redemption,frank_darabont).
actor(the_shawshank_redemption,tim_robbins,andy_dufresne).
actor(the_shawshank_redemption,morgan_freeman,ellis_boyd_redding).
actor(the_shawshank_redemption,bob_gunton,warden_norton).
actor(the_shawshank_redemption,william_sadler,heywood).
actor(the_shawshank_redemption,clancy_brown,captain_hadley).
actor(the_shawshank_redemption,gil_bellows,tommy).
actor(the_shawshank_redemption,mark_rolston,bogs_diamond).
actor(the_shawshank_redemption,james_whitmore,brooks_hatlen).
actor(the_shawshank_redemption,jeffrey_demunn,nineteenfortysix_da).
actor(the_shawshank_redemption,larry_brandenburg,skeet).
actor(the_shawshank_redemption,neil_giuntoli,jigger).
actor(the_shawshank_redemption,brian_libby,floyd).
actor(the_shawshank_redemption,david_proval,snooze).
actor(the_shawshank_redemption,joseph_ragno,ernie).
actor(the_shawshank_redemption,jude_ciccolella,guard_mert).
%
movie(notting_hill,1999).
director(notting_hill,roger_mitchell).
actress(notting_hill,julia_roberts,anna_scott).
actor(notting_hill,hugh_grant,william_thacker).
actor(notting_hill,richard_mccabe,tony).
actor(notting_hill,rhys_ifans,spike).
actor(notting_hill,james_dreyfus,martin).
actor(notting_hill,dylan_moran,rufus_the_thief).
actor(notting_hill,roger_frost,annoying_customer).
actor(notting_hill,henry_goodman,ritz_concierge).
actor(notting_hill,julian_rhind-tutt,time_out_journalist).
actress(notting_hill,lorelei_king,annas_publicist).
actor(notting_hill,john_shrapnel,pr_chief).
actor(notting_hill,clarke_peters,helix_lead_actor).
actor(notting_hill,arturo_venegas,foreign_actor).
actress(notting_hill,yolanda_vazquez,interpreter).
actress(notting_hill,mischa_barton,twelve-year-old_actress).
%
movie(closer,2004).
director(closer,mike_nichols).
actress(closer,julia_roberts,anna).
actor(closer,jude_law,dan).
actress(closer,natalie_portman,alice).
actor(closer,clive_owen,larry).
actor(closer,nick_hobbs,taxi_driver).
actor(closer,colin_stinton,customs_officer).
%
movie(erin_brockovich,2000).
director(erin_brockovich,steven_soderbergh).
actress(erin_brockovich,julia_roberts,erin_brockovich).
actor(erin_brockovich,david_brisbin,dr_jaffe).
actor(erin_brockovich,dawn_didawick,rosalind).
actor(erin_brockovich,albert_finney,ed_masry).
actor(erin_brockovich,valente_rodriguez,donald).
actress(erin_brockovich,conchata_ferrell,brenda).
actor(erin_brockovich,george_rocky_sullivan,los_angeles_judge).
actor(erin_brockovich,pat_skipper,defending_lawyer).
actor(erin_brockovich,jack_gill,defendant).
actress(erin_brockovich,irene_olga_lopez,mrs_morales).
actress(erin_brockovich,emily_marks,beth_brockovich__8_months).
actress(erin_brockovich,julie_marks,beth_brockovich__8_months).
actor(erin_brockovich,scotty_leavenworth,matthew_brockovich).
actress(erin_brockovich,gemmenne_de_la_pena,katie_brockovich).
actress(erin_brockovich,erin_brockovich-ellis,julia_the_waitress).
%
movie(my_best_friends_wedding,1997).
director(my_best_friends_wedding,pj_hogan).
actress(my_best_friends_wedding,julia_roberts,julianne_potter).
actor(my_best_friends_wedding,dermot_mulroney,michael_oneal).
actress(my_best_friends_wedding,cameron_diaz,kimberly_wallace).
actor(my_best_friends_wedding,rupert_everett,george_downes).
actor(my_best_friends_wedding,philip_bosco,walter_wallace).
actor(my_best_friends_wedding,m_emmet_walsh,joe_oneal).
actress(my_best_friends_wedding,rachel_griffiths,samantha_newhouse).
actress(my_best_friends_wedding,carrie_preston,mandy_newhouse).
actress(my_best_friends_wedding,susan_sullivan,isabelle_wallace).
actor(my_best_friends_wedding,christopher_masterson,scotty_oneal).
actress(my_best_friends_wedding,raci_alexander,title_sequence_performer_no1).
actress(my_best_friends_wedding,jennifer_garrett,title_sequence_performer_no2).
actress(my_best_friends_wedding,kelleia_sheerin,title_sequence_performer_no3).
actress(my_best_friends_wedding,bree_turner,title_sequence_performer_no4).
actress(my_best_friends_wedding,cassie_creasy,flower_girl).
%
movie(fireflies_in_the_garden,2008).
director(fireflies_in_the_garden,dennis_lee).
actor(fireflies_in_the_garden,ryan_reynolds,michael_taylor).
actor(fireflies_in_the_garden,willem_dafoe,charles_taylor).
actress(fireflies_in_the_garden,emily_watson,jane_lawrence).
actress(fireflies_in_the_garden,carrie-anne_moss,kelly_hanson).
actress(fireflies_in_the_garden,julia_roberts,lisa_taylor).
actor(fireflies_in_the_garden,ioan_gruffudd,addison_wesley).
actress(fireflies_in_the_garden,hayden_panettiere,young_jane_lawrence).
actor(fireflies_in_the_garden,shannon_lucio,ryne).
actor(fireflies_in_the_garden,cayden_boyd,young_michael).
actor(fireflies_in_the_garden,george_newbern,jimmy).
actor(fireflies_in_the_garden,chase_ellison,christopher).
actress(fireflies_in_the_garden,brooklynn_proulx,leslie).
actress(fireflies_in_the_garden,diane_perella,flight_attendant).
actress(fireflies_in_the_garden,natalie_karp,social_worker).
actor(fireflies_in_the_garden,john_c_stennfeld,reverend_byers).
%
